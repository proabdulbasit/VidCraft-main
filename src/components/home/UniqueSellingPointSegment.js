        ...
        <div className="rounded-xl w-full grid grid-flow-row lg:grid-flow-row grid-cols-1 lg:grid-cols-3 py-9 bg-white-500 z-10 gap-6">
          {sellingPoints.map((sellingPoint, index) => (
            <div
              ...
              className="flex justify-start sm:justify-center py-4 px-6 w-8/12 rounded-xl sm:w-auto mx-auto sm:mx-0 bg-custom-200 shadow-primary-100 hover:shadow-xl"
            >
              <div className="mx-auto w-40 sm:w-auto">
                <div className="flex flex-col">
                  <div className='flex align-center'>
                    <div className="text-xl pt-1 mr-2 text-primary-100">{sellingPoint.icon}</div>
